...
- **Windows registry is now data-driven** — the Windows build embeds and validates `registry/windows.json` at build/runtime instead of carrying a duplicated hardcoded package table in Zig source.
